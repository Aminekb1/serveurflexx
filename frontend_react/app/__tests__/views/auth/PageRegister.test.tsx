// frontend_react/app/__tests__/views/auth/PageRegister.test.tsx
...
// component
import BoxedRegister from '../../../src/views/auth/register/page';

describe('BoxedRegister page', () => {
  test('renders logo, AuthRegister and link to login', () => {
    render(<BoxedRegister />);
    ...
    expect(screen.getByText(/Sign Up on Serveurflex/i)).toBeInTheDocument();
